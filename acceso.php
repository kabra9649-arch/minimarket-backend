  ...
  <div class="login-right">
    ...
    <div class="auth-body">
      ...
      <div class="tab-pane <?= $esCliente?'show':'' ?>" id="tabCliente">
        ...
        <button class="btn btn-outline-success w-100 btn-sm mt-1" onclick="switchTab('registro')">Crear cuenta gratis</button>
      </div>
